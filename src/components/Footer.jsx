...
export default function Footer() {
    return (
        <footer className="bg-gray-900 text-gray-300 mobile_spaces lg_spaces">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 border-b border-gray-800 pb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input type="email" placeholder="Email address" className="bg-gray-800 border border-gray-700 text-white px-4 py-2.5 rounded-lg text-sm w-full focus:outline-none focus:border-[var(--theme-color)] transition-colors" />
                            <button className="bg_color hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg transition-colors">
