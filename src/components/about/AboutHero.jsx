        ...
        <section className="bg-white py-16 md:py-24">
            <div className="container-width mx-auto px-4 md:px-16 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 space-y-6">
                    <span className="inline-block text-blue-600 font-bold tracking-widest text-xs uppercase">
                    ...
                    <div className="flex items-center gap-4 pt-4">
                        <button className="bg-[#2563EB] text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-blue-700 transition shadow-lg shadow-blue-200">
                            Our Story ↗
                        </button>
                        <button className="flex items-center gap-2 border border-blue-200 text-blue-600 px-8 py-3.5 rounded-lg font-semibold hover:bg-blue-50 transition">
