                ...
                <div className="flex-1 px-4 py-6 md:px-8 lg:px-12 lg:py-10 pt-4 lg:pt-8 space-y-8 lg:space-y-12">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between bg-white px-3 py-4 md:px-4 md:py-5 lg:px-3 lg:py-4 rounded-[32px] md:rounded-[28px] border border-gray-100 shadow-sm relative overflow-hidden group gap-3">
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-400 text-base md:text-lg font-[500] tracking-tight">Here&apos;s what&apos;s happening in your stable today.</p>
                        </div>
                        <button className="relative z-10 w-full lg:w-auto bg_color text-white px-8 py-4 md:px-5 md:py-4 rounded-[20px] md:rounded-[15px] font-black shadow-lg hover:opacity-90 hover:scale-[1.02] active:scale-95 transition-all text-xs uppercase tracking-widest flex items-center justify-center gap-4 cursor-pointer">
