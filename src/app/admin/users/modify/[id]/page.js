    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-[32px] font-black text-[#1E293B] tracking-tight mb-1">Modify User</h1>
                    <p className="text-[#64748B] font-medium tracking-tight">Update platform account details and permissions.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <section className="bg-white p-8 rounded-[32px] border border-[#F1F5F9] shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-widest ml-1">New Password</label>
                                <input
                                    type="password"
                            ...
                            <div className="space-y-2">
                                <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-widest ml-1">Confirm New Password</label>
                                <input
                                    type="password"
                                    placeholder="••••••••"
                                    className="w-full px-5 py-3 bg-[#F8FAFC] border-none rounded-xl text-sm font-medium focus:ring-2 focus:ring-[#2563EB]/10 transition-all outline-none"
                            ...
                            {["Buyer", "Seller", "Admin"].map((role) => (
                                <label key={role} className="flex items-center gap-3 p-4 border border-[#F1F5F9] rounded-2xl cursor-pointer hover:bg-gray-50 transition-all group">
                                    <input
                                        ...
                                        name="role"
                                        value={role}
                                        defaultChecked={userData.role === role}
                                        className="w-4 h-4 text-[#2563EB] focus:ring-[#2563EB]/10 border-[#E2E8F0]"
                                    />
