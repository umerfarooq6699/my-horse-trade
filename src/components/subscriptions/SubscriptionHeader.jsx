...
export default function SubscriptionHeader() {
    ...
    return (
        <section className="bg-white text-center flex flex-col items-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0F172A] mb-4">
            ...
            {/* Billing Toggle */}
            <div className="flex items-center bg-blue-50/50 p-1.5 rounded-2xl border border-blue-100/50 mb-4 sm:mb-9">
                <button
