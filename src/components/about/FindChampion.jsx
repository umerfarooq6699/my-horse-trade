    ...
    return (
        <section className="bg-white py-10 px-4 sm:px-6">
            <div className="w-full md:w-[85%] lg:w-[70%] mx-auto">
                <div className="relative bg_color rounded-3xl sm:rounded-[32px] overflow-hidden p-8 sm:p-12 md:py-14 text-center shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            <Link href="/marketplace" className="w-full sm:w-min whitespace-nowrap px-10 py-4 bg-white text_color font-bold rounded-xl hover:bg-gray-100 transition shadow-lg">
                                Browse Horses
                            </Link>
